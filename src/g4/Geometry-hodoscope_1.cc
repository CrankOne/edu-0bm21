...
//
//#include "g4/Geometry-hodoscope_1.hh"
//
//G4LogicalVolume *
...
//    // - solid
//    G4VSolid * solidHodoscopePlane_1
...
//                   );
//    // - logic
//    G4LogicalVolume * logicHodoscopePlane_1
//        = new G4LogicalVolume(
//                   solidHodoscopePlane_1  // its solid
//                 , G4NistManager::Instance()->FindOrBuildMaterial("G4_AIR")  // its material
//                 , "hodoscopePlane");
//    
//    // Create single slab
//    // - solid (single slab)
//    G4VSolid * solidHodoscopeSlab_1
...
//                   );
//    // - logc (single slab)
//    G4LogicalVolume * logicHodoscopeSlab_1
//        = new G4LogicalVolume(
//                   solidHodoscopeSlab_1  // its solid
//                 , G4NistManager::Instance()->FindOrBuildMaterial("G4_AIR")  // its material, TODO
//                 , "hodoscopeSlab_1");   // its name
//    // - replica
//    new G4PVReplica( "hodoscopeSlabReplicae_1"  // name
//                , logicHodoscopeSlab_1  // logical vol to replicate
//                , logicHodoscopePlane_1 // mother logical volume (encompassing volume)
